...
import {
  BrowseByCategory,
  CategoriesSkeleton,
} from "@/components/home/BrowseByCategory";
import {
  FlaskConical,
  Shield,
  Truck,
...
export const metadata: Metadata = {
  title:
    "BestExpressPeptides | Premium Research-Grade Peptides for Scientific Research",
  description:
    "Discover our comprehensive collection of laboratory-grade research peptides. 99%+ purity verified, fast shipping, and certificates of analysis. For research use only.",
  openGraph: {
    title: "BestExpressPeptides | Premium Research-Grade Peptides",
    description:
      "Discover our comprehensive collection of laboratory-grade research peptides. 99%+ purity verified.",
    type: "website",
  },
  keywords:
    "research peptides, laboratory peptides, peptide research, scientific peptides, USA peptides, HPLC verified peptides",
};
          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Why Choose BestExpressPeptides?
              </h2>
              <p className="text-muted-foreground">
                We are committed to providing the highest quality research
                peptides for the scientific community.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Every peptide undergoes rigorous HPLC testing to ensure 99%+
                    purity for reliable research results.
                  </p>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Temperature-controlled shipping ensures your peptides arrive
        ...
        {/* <section className="py-16 bg-primary text-white">
          <div className="container-custom text-center">
            ...
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
              Browse our extensive catalog of research-grade peptides and find
              the compounds you need for your studies.
            </p>
            <Button
              size="lg"
              asChild
